...
class user_input(BaseModel):
    ...
    occupation:Annotated[Literal['retired','unemployed','government_job','student','freelancer','business','private_job'],Field(...,description="Occupation of the User")]
...
def predict_premium(data:user_input):
    ...
    return JSONResponse(
    status_code=200,
    content={"predicted category is": str(prediction)}
)